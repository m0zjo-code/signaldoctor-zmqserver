...
input_data = np.load("nnetsetup/CecTrainingData.npz")
...
model = Sequential()
model.add(Dense(2**3, activation='tanh', input_shape=(256,256,1)))
model.add(Flatten())
...
with open("cecmodel.nn", "w") as json_file:
    json_file.write(model_json)
# serialize weights to HDF5
model.save_weights("cecmodel.h5")
